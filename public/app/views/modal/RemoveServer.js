...
define(['jquery', 'underscore', 'marionette', 'App', 'text!views/modal/templates/remove-server.html', 'bootstrap_modal', 'bootstrap_transition'], function($, _, BackboneMarionette, App, removeServerTpl) {
  /**
