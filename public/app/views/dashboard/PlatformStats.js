...
define(['jquery', 'underscore', 'backbone', 'marionette', 'backbone_modelbinder', 'text!views/dashboard/templates/platform-stats.html'], function($, _, Backbone, BackboneMarionette, BackboneModelBinder, platformStatsTpl) {
  /**
   * @class PlatformStats
