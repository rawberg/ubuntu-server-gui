...
define(['jquery', 'underscore', 'marionette', 'models/PlatformInfo', 'collections/NetServices', 'views/dashboard/LeftSidebar', 'views/dashboard/UtilizationStats', 'views/dashboard/PlatformStats', 'views/dashboard/RunningServices', 'text!views/dashboard/templates/layout.html'], function($, _, BackboneMarionette, PlatformInfoModel, NetServices, LeftSidebar, UtilizationStats, PlatformStats, RunningServices, dashboardLayoutTpl) {
  /**
   * @class Dashboard
