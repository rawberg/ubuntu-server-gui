...
define(['jquery', 'underscore', 'App', 'collections/ServerList', 'views/UsgCollectionView', 'views/dashboard/LeftSidebarItem', 'views/modal/AddEditServer', 'views/modal/RemoveServer', 'contextmenu'], function($, _, App, ServerList, UsgCollectionView, LeftsidebarItem, AddEditServerModal, RemoveServerModal, ContextMenu) {
  /**
   * @class LeftSidebar
