...
define(['jquery', 'underscore', 'backbone', 'backbone_marionette', 'backbone_modelbinder', 'app', 'model/ServerOverview', 'gauge', 'text!view/dashboard/tpl/utilization-stats.html'], function($, _, Backbone, BackboneMarionette, BackboneModelBinder, App, ServerOverview, Gauge, utilizationStatsTpl) {
  /**
